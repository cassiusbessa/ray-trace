...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/09/06 00:40:35 by emorshhe          #+#    #+#             */
/*   Updated: 2025/09/06 00:49:09 by emorshhe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void							add_intersection_to_list(t_intersection_list *list,
									t_intersection i);

void							join_lists(t_intersection_list *dest,
									t_intersection_list *src, t_bool free_src);
...
void							add(t_intersection_node *n,
									t_intersection_list *list);

void							add_node_ordered(float t,
									t_intersection_list *list, t_object *o);
