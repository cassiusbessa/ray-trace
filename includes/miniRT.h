...
t_tuple							multiply_tuple_by_scalar(t_tuple t,
									float scalar);
...
void							canvas_to_mlx_image(t_canvas *canvas,
									t_mlx *data);
...
t_matrix						matrix_multiply_by_matrix(t_matrix a,
									t_matrix b);
...
void							add_object_to_world(t_world *world,
									t_object object);
void							add_light_to_world(t_world *world,
									t_point_light light);
