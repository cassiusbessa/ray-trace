...
static void compute_rotation_axis(t_tuple orientation, t_tuple *axis, double *cos_theta, double *sin_theta)
{
    t_tuple up;
...
static t_matrix build_rotation_matrix(double cos_theta, double sin_theta, t_tuple axis)
{
    double  x;
    double  y;
    double  z;
