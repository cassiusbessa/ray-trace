...
static void init_basic_matrices(t_transform_params params, t_transform_matrices *mats)
{
    mats->translation = translation_matrix(params.translation[0], params.translation[1], params.translation[2]);
    ...
    mats->scaling = scaling_matrix(params.scaling[0], params.scaling[1], params.scaling[2]);
