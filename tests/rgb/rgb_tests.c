...
static int test_add_rgb(void)
{
    ...
    if (errors == 0)
        ...
        test_failure("test_add_rgb failed.");
    return (errors);
}
...
static int  test_sub_rgb(void)
{
    ...
    if (errors == 0)
        ...
        test_failure("test_sub_rgb failed.");
    return (errors);
}
...
static int  test_multiply_rgb_by_scalar(void)
{
    ...
    if (errors == 0)
        ...
        test_failure("test_multiply_rgb_by_scalar failed.");
    return (errors);
}
...
static int  test_multiply_rgb_by_rgb(void)
{
    ...
    if (errors == 0)
        ...
        test_failure("test_multiply_rgb_by_rgb failed.");
    return (errors);
}
